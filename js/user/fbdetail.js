    ...
    fbdetailObj.fkcontentObj = function(res){
        ...
        for (var i = 0; i < imgs.length; i++) {
            html += '<li data-t="liImg" data-g="'+ imgs[i] +'" class="li_img_fk"><img class="fk_img" style="background:url(images/channel/chan_003.png);background-size:100% 100%;" src="'+ imgs[i] +'" alt=""></li>'
        }
