            ...
            for (var i = 0; i < data.length; i++) {
                html += '<div class="div_lst">\
                            <ul>\
                                ...
                                <li data-t="userxin" data-d="'+ data[i].user_id +'" style="width:62%;" class="liLive liw65">\
                                    <p class="liveName">'+data[i].nickname+'<span class="pColo"><i class="'+(data[i].online == 'OFF' ? 'grtime' : 'iTime') +'"></i>'+(data[i].online =='OFF'?'離線':'在線')+'</p>\
                                    <p class="pColo hid">'+ (data[i].craft == '' ? '一条个性的签名' : data[i].craft )+'</p>\
                                </li>\
                                <li data-t="tjgz" data-d="'+ data[i].user_id +'" style="width:20%;" class="liLive liw17">\
                ...
                html += '<div class="div_lst">\
                            <ul>\
                                ...
                                <li data-t="userxin" data-d="'+ data[i].user_id +'" class="liLive liw65">\
                                    ...
                                    <p class="pColo hid">'+ (data[i].craft == '' ? '一條有個性的簽名' : data[i].craft )+'</p>\
                                </li>\
                                <li data-t="tjgz" data-l="'+ tp +'" data-d="'+ data[i].user_id +'" class="liLive liw17"><span data-l="'+ tp +'" class="sgz '+ (data[i].followed == '0' ? 'sgz' : 'sygz') +'">'+ (data[i].followed == '0' ? '+關注' : '已關注') +' </span></li>\
                            </ul>\
                        </div>'
            }
            $('#sec_liveList').html(html)
        ...
        if(arrLen > 0){
           if(tp == '3'){
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                result += '<div class="div_lst">\
                            <ul>\
                                <li data-t="userxin" data-d="'+ data[i].user_id +'" data-t="Ldetil" class="liLive liw18"><img class="w100 rad5" src="'+ data[i].avatar_url+'" alt="#"></li>\
                                <li data-t="userxin" data-d="'+ data[i].user_id +'" data-t="Ldetil" class="liLive liw65">\
                                    <p class="liveName">'+ data[i].nickname +' <span class="pColo"><i class="'+ (data[i].online == 'OFF' ? 'grtime' : 'iTime') +'"></i>'+ (data[i].online == 'OFF' ? '離線' : '在線') +'</span></p>\
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if (res.err == undefined) {
                    ...
                    if (obj.attr('data-l') == '2') {
                        $(txtObj).html('+關注')
                        $(obj).parents('.div_lst').hide()
                    }else{
                        if ($(txtObj).html() === '已關注') {
                            $(txtObj).html('+關注')
                        }else{
